...
<template>
  <div class="svg-container">
    <a :href="href" :aria-label="title" class="icon-link">
      <svg
        version="1.0"
        ...
        aria-labelledby="Pdf"
        role="presentation"
        class="icon about__icon icon__pdf"
      >
        ...
        >
          <path
            d="M1166 5104 c-123 -30 -250 -118 -322 -224 -17 -25 -44 -76 -60 -115
   ...
   -165 0 -165 0 0 -185 0 -185 -105 0 -105 0 0 460 0 460 285 0 285 0 0 -85z"
          />
          <path
            d="M1267 1953 c-4 -3 -7 -66 -7 -140 l0 -133 68 0 c106 0 168 44 179
   127 8 59 -20 111 -71 134 -40 18 -155 27 -169 12z"
          />
          <path
            d="M2078 1954 c-17 -5 -18 -28 -18 -305 l0 -299 27 -6 c41 -11 172 14
